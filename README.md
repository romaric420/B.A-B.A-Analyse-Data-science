...
### 1. **BA-BA Analyse (Exploratory Data Analysis - EDA)** :bar_chart:
   ...
   ![Exploratory Data Analysis](https://media.giphy.com/media/Xq7h9KUzmlZ7g/giphy.gif)  
...
### 2. **Pipeline** :gear:
   ...
   ![Pipeline Animation](https://media.giphy.com/media/3o7ZigtnZIbDpoFb0U/giphy.gif)
...
### 3. **Preprocessing** :wrench:
   ...
   ![Preprocessing](https://media.giphy.com/media/26FwpE3HHREpmb35i/giphy.gif)
...
### 4. **PolynomialFeatures** :bar_chart: ➗
   ...
   ![Polynomial Features](https://media.giphy.com/media/43Jndn5VY6WbI/giphy.gif)
...
### 7. **Gestion des NaN (Not a Number)** :x:
   ...
   ![Handling Missing Data](https://media.giphy.com/media/f9E6k3OjA7h1a/giphy.gif)
...
### 8. **Tests Statistiques** :mag_right:
   ...
   ![Hypothesis Testing](https://media.giphy.com/media/jtU8nNrdBly4w/giphy.gif)
